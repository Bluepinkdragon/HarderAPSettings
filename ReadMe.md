...
A mod for Hollow Knight to make the game harder, meant to be used in APs(Archipelagos, a multiworld randomizer) but works just fine for any other type of game (Normal, Steel Soul, Randomizer, etc).
Requires `HKMirror` to work.
...
> [!WARNING]
> Mod is currently incompatible with [Combat Randomizer](https://github.com/nerthul11/CombatRandomizer/)'s Nail damage setting


## Credits
A mod made by @wolfunite and @bluepinkdragon on discord
